...
object P2PGatewayApi
{
    ...
    class SetMultiObjects : TUTKP2PCommander()
    {
        override fun requestURL(): String
        {
            return "{\"URI\":\"${AppConfig.API_MULTI_OBJECTS}\"${getRequestPayload()}}"
        }
    ...
    class GetFWLogFile : TUTKP2PCommander()
    {
        override fun requestURL(): String
        {
            return "{\"URI\":\"${AppConfig.API_SYS_LOG}\"}"
        }
