...
class CloudAddMeshWiFiTipsFragment : Fragment()
{
    ...
    {
        cloud_mesh_wifi_tip_FOL_image.setImageResource(if(show) R.drawable.icon_back else R.drawable.icon_detail)
    ...
    {
        cloud_mesh_wifi_tip_CLQ_image.setImageResource(if(show) R.drawable.icon_back else R.drawable.icon_detail)
