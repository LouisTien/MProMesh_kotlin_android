...
import kotlinx.android.synthetic.main.fragment_cloud_add_mesh_ethernet_tips.*
...
class CloudAddMeshEthernetTipsFragment : Fragment()
{
    ...
    {
        return inflater.inflate(R.layout.fragment_cloud_add_mesh_ethernet_tips, container, false)
    }
    ...
    private val clickListener = View.OnClickListener { view ->
        when(view)
        {
            cloud_mesh_ethernet_tip_cancel_image -> GlobalBus.publish(MainEvent.SwitchToFrag(CloudAddMeshCableInfoFragment()))

            cloud_mesh_ethernet_tip_FOL_title_relative ->
            {
                FOLENable = !FOLENable
                updateFOL()
            }

            cloud_mesh_ethernet_tip_CLQ_title_relative ->
            {
                CLQEnable = !CLQEnable
                updateCLQ()
            }
    ...
    {
        cloud_mesh_ethernet_tip_cancel_image.setOnClickListener(clickListener)
        cloud_mesh_ethernet_tip_FOL_title_relative.setOnClickListener(clickListener)
        cloud_mesh_ethernet_tip_CLQ_title_relative.setOnClickListener(clickListener)
    }
