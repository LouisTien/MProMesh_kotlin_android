...
import kotlinx.android.synthetic.main.fragment_cloud_add_mesh_tips.*
...
class CloudAddMeshTipsFragment : Fragment()
{
    ...
    {
        return inflater.inflate(R.layout.fragment_cloud_add_mesh_tips, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?)
    {
        ...
        cloud_mesh_tip_cancel_image.setOnClickListener{
            when(fromFrag)
            {
